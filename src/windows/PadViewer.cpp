...
// TODO: Отзеркаленые текстуры сильно перескакивают (Возможно из-за зеркалирования anchor или из-за того что не учитываются crops, нужно изучить)
// TODO: Понимать размер всего контейнера с тенью, чтобы можно было отрисовать фон за тенью
// TODO: Учитывать crops
// TODO: Добавить отображение фонового рисунка (как в MdfViewer)
